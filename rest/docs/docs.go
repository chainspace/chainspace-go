...
// 2018-11-22 12:34:05.251491 +0000 GMT m=+0.379855566
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/api.StateReportResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "api.StateReportResponse": {
            ...
            "properties": {
                ...
                "states": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.StateReport"
                    }
                }
            }
        },
        "api.Trace": {
            ...
            "properties": {
                ...
                "labels": {
                    "type": "array",
                    "items": {
                        "type": "\u0026{%!s(token.Pos=1379) \u003cnil\u003e string}"
                    }
                },
                "output_objects": {
                    "type": "array",
